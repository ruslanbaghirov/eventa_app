  ...
  return (
    <div className="flex gap-3">
      ...
      <button
        ...
        disabled={loading}
        className={`flex-1 flex items-center justify-center gap-2 px-4 py-2.5 rounded-md font-bold transition-all border-2 disabled:opacity-50 disabled:cursor-not-allowed ${
          rsvpType === "interested"
            ? "bg-gray-900 border-gray-900 text-white hover:bg-gray-700 hover:border-gray-700"
            : "bg-white border-gray-400 text-gray-900 hover:border-gray-900"
        }`}
      >
